...
```bash
npx esno ./tests/e2e/coverage/runner.ts ./dist/zen-charts.standalone.development.js
```
...
```bash
GENERATE_COVERAGE_FILE=true node ./tests/e2e/coverage/runner.js ./dist/zen-charts.standalone.development.js
```
...
```bash
PRODUCTION_BUILD=false DEVICE_PIXEL_RATIO=1.5 npx esno ./tests/e2e/graphics/runner.ts ./golden/zen-charts.standalone.development.js ./dist/zen-charts.standalone.development.js
```
...
```bash
npx esno ./tests/e2e/memleaks/runner.ts ./dist/zen-charts.standalone.development.js
```
...
```bash
npx esno ./tests/e2e/interactions/runner.ts ./dist/zen-charts.standalone.development.js
```
