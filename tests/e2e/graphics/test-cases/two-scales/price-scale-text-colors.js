...
function runTestCase(container) {
	...
	const series1 = chart.addSeries(ZenCharts.LineSeries, { color: 'red', priceScaleId: 'right' });
	const series2 = chart.addSeries(ZenCharts.LineSeries, { color: 'blue', priceScaleId: 'left' });
