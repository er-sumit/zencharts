...
function runTestCase(container) {
	...
	// To simulate interaction / data update over time (forcing the renderer to repaint),
	// we update the data slightly, which triggers `subscribeDataChanged` and redraws the plugin.
	mainSeries.update({ time: 1600000000 + 100 * 86400, value: 200 });
