...
function createChart(container) {
	chart = window.chart = ZenCharts.createChart(container, { layout: { attributionLogo: false } });
}

function createFirstSeries() {
	areaSeries1 = chart.addSeries(ZenCharts.AreaSeries);
	data1 = generateData(61, Date.UTC(2018, 0, 1, 0, 0, 0, 0));
	areaSeries1.setData(data1);
}

function createSecondSeries() {
	areaSeries2 = chart.addSeries(ZenCharts.AreaSeries, {
		lineColor: 'red',
	});
