function runTestCase(container) {
	...
	const line = chart.addSeries(ZenCharts.LineSeries);
	const area = chart.addSeries(ZenCharts.AreaSeries);
	const candlestick = chart.addSeries(ZenCharts.CandlestickSeries);
	const bar = chart.addSeries(ZenCharts.BarSeries);
	const histogram = chart.addSeries(ZenCharts.HistogramSeries);
