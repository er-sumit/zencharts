function runTestCase(container) {
	...
	const areaSeries1 = chart.addSeries(ZenCharts.AreaSeries, {
		lineColor: '#2962FF',
		topColor: '#2962FF',
	...
	const areaSeries2 = chart.addSeries(ZenCharts.AreaSeries, {
		lineColor: '#ff29b4',
		topColor: '#510a60',
	...
	const areaSeries3 = chart.addSeries(ZenCharts.AreaSeries, {
		lineColor: '#10ec1b',
		topColor: '#10ec1b',
