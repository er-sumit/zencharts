...
function checkSeries(series, data, compareItemsFn) {
	...
	console.assert(
		compareAreaData(series.dataByIndex(-1, ZenCharts.MismatchDirection.NearestRight), series.dataByIndex(0)),
	...
	console.assert(
		compareAreaData(series.dataByIndex(originalData.length, ZenCharts.MismatchDirection.NearestLeft), series.dataByIndex(originalData.length - 1)),
...
function runTestCase(container) {
	...
	const candlestickSeries = chart.addSeries(ZenCharts.CandlestickSeries);
	...
	const baselineSeries = chart.addSeries(ZenCharts.BaselineSeries);
