...
function beforeInteractions(container) {
	...
	leftSeries = chart.addSeries(ZenCharts.CandlestickSeries, {
		priceScaleId: 'left',
		lastPriceAnimation: ZenCharts.LastPriceAnimationMode.OnDataUpdate,
	});
...
async function afterInteractions() {
	...
	leftSeries.applyOptions({
		lastPriceAnimation: ZenCharts.LastPriceAnimationMode.Disabled,
	});
