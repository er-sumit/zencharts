...
function beforeInteractions(container) {
	...
	const defaultLeftSeries = chart.addSeries(ZenCharts.LineSeries);
	defaultLeftSeries.setData(generateData(1));

	const explicitRightSeries = chart.addSeries(ZenCharts.LineSeries, {
		priceScaleId: 'right',
	});
	...
	const defaultRightSeries = chart.addSeries(ZenCharts.HistogramSeries);
