...
function beforeInteractions(container) {
	...
	primitiveChart = ZenCharts.createChart(primitiveContainer, {
		rightPriceScale: { visible: false },
	});

	primitiveSeries = primitiveChart.addSeries(ZenCharts.AreaSeries, {
	...
	customChart = ZenCharts.createChart(customContainer, {
