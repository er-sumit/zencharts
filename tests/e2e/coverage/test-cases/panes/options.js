...
function beforeInteractions(container) {
	chart = ZenCharts.createChart(container, { layout: { panes: { separatorColor: '#00ff00', separatorHoverColor: '#ff0000', enableResize: true } } });

	const mainSeries = chart.addSeries(ZenCharts.LineSeries);
	const secondSeries = chart.addSeries(ZenCharts.LineSeries, {}, 1);
