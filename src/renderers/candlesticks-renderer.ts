...
import { alignBarWidthToPixelGrid, optimalCandlestickWidth } from './optimal-bar-width';
...
export class PaneRendererCandlesticks extends BitmapCoordinatesPaneRenderer {
	...
	protected override _drawImpl(renderingScope: BitmapCoordinatesRenderingScope): void {
		...
		this._barWidth = alignBarWidthToPixelGrid(optimalCandlestickWidth(this._data.barSpacing, horizontalPixelRatio), horizontalPixelRatio);
