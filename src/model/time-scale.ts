...
import { TimeTickMarkBuilder } from './time-tick-mark-builder';
...
export class TimeScale<HorzScaleItem> implements ITimeScale {
	...
	private readonly _timeTickMarkBuilder: TimeTickMarkBuilder<HorzScaleItem>;
	...
	public constructor(model: ChartModel<HorzScaleItem>, options: HorzScaleOptions, localizationOptions: LocalizationOptions<HorzScaleItem>, horzScaleBehavior: IHorzScaleBehavior<HorzScaleItem>) {
		...
		this._timeTickMarkBuilder = new TimeTickMarkBuilder(this);
	...
	public tickMarks(): TickMarks<HorzScaleItem> {
		return this._tickMarks;
	}

	public indicesWithData(): Map<TimePointIndex, boolean> {
		return this._indicesWithData;
	}

	public indicesWithDataUpdateId(): number {
		return this._indicesWithDataUpdateId;
	}
	...
	public isAllScalingAndScrollingDisabled(): boolean {
		return this._isAllScalingAndScrollingDisabled();
	}

	public formatLabel(tickMark: TickMark): string {
		return this._formatLabel(tickMark);
	}
	...
	public marks(): TimeMark[] | null {
		return this._timeTickMarkBuilder.marks();
	}
	...
	private _resetTimeMarksCache(): void {
		this._timeTickMarkBuilder.invalidate();
	}
