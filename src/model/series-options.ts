...
/**
 * Represents common line style properties for line-based series.
 */
export interface SeriesLineStyleProperties {
	/**
	 * Line style.
	 *
 ...
 */
export interface LineStyleOptions extends SeriesLineStyleProperties {
	/**
	 * Line color.
	 *
	 * @defaultValue `'#2196f3'`
 ...
 */
export interface AreaStyleOptions extends SeriesLineStyleProperties {
	/**
 ...
 */
export interface BaselineStyleOptions extends SeriesLineStyleProperties {
	/**
