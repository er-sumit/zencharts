...
export class SeriesBaselinePaneView extends FillSeriesPaneViewBase<'Baseline', BaselineFillItem & BaselineStrokeItem> {
	...
	public constructor(series: ISeries<'Baseline'>, model: IChartModelBase) {
		const baselineAreaRenderer = new PaneRendererBaselineArea();
		const baselineLineRenderer = new PaneRendererBaselineLine();
		super(series, model, baselineAreaRenderer, baselineLineRenderer);
		this._baselineAreaRenderer = baselineAreaRenderer;
		this._baselineLineRenderer = baselineLineRenderer;
	}
