...
export class TimeAxisWidget<HorzScaleItem> implements MouseEventHandlers, IDestroyable {
	...
	public constructor(chartWidget: ChartWidget<HorzScaleItem>, horzScaleBehavior: IHorzScaleBehavior<HorzScaleItem>) {
		...
		this._canvasBinding = createPreconfiguredCanvasBinding(this._dv, this._canvasSuggestedBitmapSizeChangedHandler, '1');
		this._topCanvasBinding = createPreconfiguredCanvasBinding(this._dv, this._topCanvasSuggestedBitmapSizeChangedHandler, '2');
